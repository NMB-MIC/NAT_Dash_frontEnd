...
class PR_Turning extends Component {
  ...
  componentDidMount = async () => {
    ...
    let mc_list_data = await httpClient.get(server.list_machine_TUN);
    await this.setState({
  ...
  data_by_total = async () => {
    let day_ttl = await httpClient.post(server.DAILY_TOTAL_TUN, {
  ...
  data_by_mc = async () => {
    let mc_ttl = await httpClient.post(server.DAILY_OUT_MC, {
      date_start: this.state.date_start,
      date_end: this.state.date_end,
      process: this.state.selected_process,
      selected_mc: this.state.selected_mc,
    ...
    await this.setState({
      ...
      options: {
        title: {
          text: 'TURNING OUTPUT BY MACHINE',
          align: 'center',
          style: {
            fontSize: '30px',
            fontWeight: 'bold',
  ...
  month_data_output = async () => {
    let day_ttl = await httpClient.post(server.MONTHLY_total_outputTN, {
  ...
  daily_CTandUTL = async () => {
    let day_ct = await httpClient.post(server.daily_CT_TUN, {
      date_start: this.state.date_start,
      date_end: this.state.date_end,
      selected_mc: this.state.selected_mc,
    })
    ...
    let day_UTL = await httpClient.post(server.daily_UTL_TUN, {
      date_start: this.state.date_start,
      date_end: this.state.date_end,
      selected_mc: this.state.selected_mc,
    })
  ...
  month_CTandUTL = async () => {
    let day_ct = await httpClient.post(server.CT_month, {
      date_start: this.state.date_start,
      date_end: this.state.date_end,
      selected_mc: this.state.selected_mc,
    })
    ...
    let day_UTL = await httpClient.post(server.UTL_month, {
      date_start: this.state.date_start,
      date_end: this.state.date_end,
      selected_mc: this.state.selected_mc,
    })
    ...
    return (<div className="content-wrapper">
      <section className="content-header">
        <div className="container-fluid">
          <h2 className="text-center" style={{ fontWeight: 'bold' }} >TURNING PRODUCTION RESULT </h2>
        </div>
      </section>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3" >
                        <div>
                          ...
                          <div classNamr="col-md-2" style={{ borderStyle: "groove", borderRadius: 5 }}> &nbsp;{this.renderTable_machine()}</div>
                          <div className="card">
