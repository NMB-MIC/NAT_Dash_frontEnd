...
class Dash_IRB extends Component {
  ...
  componentDidMount = async () => {
    let mc_list_data = await httpClient.post(server.list_machine_IRB);
    this.setState({
  ...
  show_chart_output = async () => {
    // output chart
    let output_data = await httpClient.post(server.IRB_OUTPUT, {
  ...
  cycle_time = async () => {
    let mc_ttl = await httpClient.post(server.IRB_CT, {
      date: this.state.date_start,
      machine: this.state.selected_machine,
  ...
  // get cycle time and UTL 
  getCT_byHour = async () => {
    let CT = await httpClient.post(server.IRB_ct_byHour, {
      date: this.state.date_start,
      machine: this.state.selected_machine,
    });
    let UTL = await httpClient.post(server.IRB_UTL, {
      date: this.state.date_start,
      machine: this.state.selected_machine,
    })
      ...
      <div className="content-wrapper">
        <section className="content-header">
          <div className="container-fluid">
            <h2 className="text-center" style={{ fontWeight: 'bold' }} > IRB GRINDING DASHBOARD </h2>
          </div>
        </section>
        <div className="row">
              ...
              <div className="col-md-12">
                <div className="row" >
                  ...
                  <div className="col-md-2">
                    ...
                    <input style={{ fontWeight: "bold", fontSize: 20, textAlign: 'center' }} value="GRINDING" type="text" className="form-control" />
                  </div>
                  <div className="col-md-2">
                    <h5>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-6">
                  ...
                  <ReactApexChart options={this.state.output_options} series={this.state.output_series} type="line" height={500} />
                </div>
                <div className="col-md-6">
                  <ReactApexChart options={this.state.accumulate_options} series={this.state.accumulate_series} type="line" height={500} />
                </div>
              </div>
            </div>
          </div>
